 ...
 *
 * <p>Implementations are expected to be non-blocking from the caller's perspective —
 * the message is handed off to the queue and the method returns immediately,
 * decoupling the OTP generation request path from the email delivery infrastructure.</p>
 */
public interface OtpEmailPublisher {
     ...
     * @throws RuntimeException if the message cannot be published (e.g., SQS unavailable)
     */
