...
public interface AuthService {
     ...
     *
     * @throws com.org.auth.exception.PasswordResetTokenException if the token is
     ...
     *
     * @throws com.org.auth.exception.ResourceNotFoundException if no user exists with the given ID
     */
     ...
     *
     * @throws com.org.auth.exception.EmailAlreadyExistsException if the email is already taken
     */
     ...
     *
     * @throws com.org.auth.exception.ResourceNotFoundException if the user does not exist
     * @throws com.org.auth.exception.EmailAlreadyExistsException if the new email is already taken
     */
     ...
     * @throws com.org.auth.exception.ResourceNotFoundException if the user does not exist
     * @throws com.org.auth.exception.BusinessException if the status is NEW or DELETED (system-managed),
     ...
     * @param requestingAdminId the ID of the admin making the request (self-action guard)
     * @throws com.org.auth.exception.ResourceNotFoundException if the user does not exist
     * @throws com.org.auth.exception.BusinessException if the admin attempts self-deletion
     */
